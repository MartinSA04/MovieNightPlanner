...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  const feedbackTone = params.error
  ...
  return (
    ...
    >
      {(params.error || params.message) && (
        <div className={`rounded-2xl border px-4 py-3 text-sm ${feedbackTone}`}>
          {params.error ?? params.message}
        </div>
      )}
      ...
      <section className="grid gap-6 lg:grid-cols-2">
        <Panel className="space-y-5">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-slate-950">Existing account</h2>
          </div>
        ...
        <Panel tone="muted" className="space-y-5">
          <div className="space-y-2">
            ...
            <h2 className="text-2xl font-semibold tracking-tight text-slate-950">New account</h2>
          </div>
